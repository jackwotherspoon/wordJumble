...
void testJumble() {
	...
	// Testing Exceptions
	//too short word
	cout << "Testing correct error for too short input string." << endl;
	try {
		JumblePuzzle jpShortInput("TO", "easy");
	}
	catch (BadJumbleException& e) {
		cerr << e.what() + "\n" << endl;
	}
	// too long word
	cout << "Testing correct error for too long input string" << endl;
	try {
		JumblePuzzle jpLongInput("momentously", "easy");
	}
	catch (BadJumbleException& e) {
		cerr << e.what() + "\n" << endl;
	}
	// invalid difficulty
	cout << "Test exception for inputting incorrect difficulty" << endl;
	try {
		JumblePuzzle jpDifficulty("Test", "impossible");
	}
	catch (BadJumbleException& e) {
		cerr << e.what() + "\n" << endl;
	}
	...
	//getWord
	cout << "Testing getWord():" << endl;
	JumblePuzzle jpTestAccessors("Test", "easy");
	cout << "Should return 'Test':" << endl;
	cout << "Output: " + jpTestAccessors.getWord() + "\n" << endl;
	//getDifficulty
	cout << "Testing getDifficulty(): " << endl;
	cout << "Should return 'easy':" << endl;
	cout << "Output: " + jpTestAccessors.getDifficulty() + "\n" << endl;
	//getSize
	cout << "Testing getSize():" << endl;
	cout << "should return 8: " << endl;
	cout << "Output: " + to_string(jpTestAccessors.getSize()) + "\n" << endl;
	//get starting position of word
	cout << "Testing getColPos(), getRowPos(), and getDirection():" << endl;
	showJumble(jpTestAccessors.getJumble(), jpTestAccessors.getSize());
	cout << "Row should be: " + to_string(jpTestAccessors.getRowPos()) << endl;
	cout << "Column should be: " + to_string(jpTestAccessors.getColPos()) << endl;
	// Testing direction 
	string S(1, jpTestAccessors.getDirection());
	cout << "Direction should be: " + S + "\n" << endl;

	//Testing difficulties and corresponding grid size 
	//test easy
	cout << "Testing that grid sizes match corresponding difficulty :" << endl;
	JumblePuzzle jpEasy("HELLO", "easy");
	cout << "Grid size should be 10x10 (0-9) :" << endl;
	showJumble(jpEasy.getJumble(), jpEasy.getSize());
	//test medium
	JumblePuzzle jpMed("HELLO", "medium");
	cout << "Grid size should be 15x15 (0-14) :" << endl;
	showJumble(jpMed.getJumble(), jpMed.getSize());
	//test hard
	JumblePuzzle jpHard("HELLO", "hard");
	cout << "Grid size should be 20x20 (0-19)" << endl;
	showJumble(jpHard.getJumble(), jpHard.getSize());
	///////////////////////////////////////////////////////////////////////////GIVEN UNIT TESTS/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	cout << "Now testing given unit tests!\n" << endl;
